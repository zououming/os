...
def test(frame_threshold):
    ...
    while(capture.isOpened()):
        ...
        if key == 27:
            break
        # frame = cv2.imread("/home/zououming/操作系统/vision/img/train/1/30.png")
        frame_count += 1
        ...
        red_num = len(red_contours)
        green_num = len(green_contours)
        ...
        if red_num == 0 and green_num ==0:
            ...
            color = "red"
        elif cv2.contourArea(red_contours[0]) > cv2.contourArea(green_contours[0]) :
            color = "red"
        elif cv2.contourArea(red_contours[0]) < cv2.contourArea(green_contours[0]) :
            color = "green"
        else:
        ...
        if color == "red":
            ...
            contour = green_contours[0]
        else:
            continue

        # print("area", cv2.contourArea(contour))  #调节面积
